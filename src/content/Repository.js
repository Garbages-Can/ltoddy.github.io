...
class Repository extends React.Component {
  ...
  stars() {
    return this.props.stargazers_count === 0 ? (
      <div />
    ) : (
  ...
  render() {
    return (
      ...
      >
          ...
          <div className={css.repo}>
            <span className={css.language}>
              <i
                ...
                style={{ color: `${languageColor[this.props.language]}` }}
              />
        ...
        <ReactTooltip id={this.props.full_name}>
          Go to {this.props.html_url.split('/').slice(-1)}
        </ReactTooltip>
      </a>
    )
  }
